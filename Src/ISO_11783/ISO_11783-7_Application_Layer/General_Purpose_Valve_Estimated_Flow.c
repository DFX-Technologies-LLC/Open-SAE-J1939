...
ISO_11783_Response_Request_General_Purpose_Valve_Estimated_Flow(J1939_t* j1939, uint8_t DA)
{
    ...
    data[2] = (j1939->this_general_purpose_valve_estimated_flow.fail_safe_mode << 6) | (0b11 << 4)
        | j1939->this_general_purpose_valve_estimated_flow
              .valve_state; /* Bit 5 and 6 are reserved for further use */
...
void ISO_11783_Read_Response_Request_General_Purpose_Valve_Estimated_Flow(J1939_t* j1939,
                                                                          ...
                                                                          uint8_t data[])
{
    j1939->from_other_ecu_general_purpose_valve_estimated_flow.extend_estimated_flow_standard
        = data[0];
    j1939->from_other_ecu_general_purpose_valve_estimated_flow.retract_estimated_flow_standard
        = data[1];
    ...
    j1939->from_other_ecu_general_purpose_valve_estimated_flow.extend_estimated_flow_extended
        = (data[5] << 8) | data[4];
    j1939->from_other_ecu_general_purpose_valve_estimated_flow.retract_estimated_flow_extended
        = (data[7] << 8) | data[6];
