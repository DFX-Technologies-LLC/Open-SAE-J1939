    ...
    switch (PGN) {
        ...
        case PGN_ADDRESS_DELETE:
            SAE_J1939_Send_Acknowledgement(j1939,
                                           ...
                                           CONTROL_BYTE_ACKNOWLEDGEMENT_PGN_SUPPORTED,
                                           GROUP_FUNCTION_VALUE_NORMAL,
                                           PGN); /* Not SAE J1939 standard */
            break;
        case PGN_DM1: SAE_J1939_Response_Request_DM1(j1939, SA); break;
        case PGN_DM2:
        ...
        case PGN_AUXILIARY_VALVE_MEASURED_POSITION_0:
            ISO_11783_Response_Request_Auxiliary_Valve_Measured_Position(
                j1939,
                PGN & 0xF); /* PGN & 0xF = valve_number */
            break;
