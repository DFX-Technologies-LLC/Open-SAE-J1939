                                                             ...
                                                             uint8_t data[])
{
    ...
    /* PGN */
    j1939->from_other_ecu_tp_cm.PGN_of_the_packeted_message
    ...
    switch (data[0]) {
        case CONTROL_BYTE_TP_CM_RTS:
            ...
            j1939->this_ecu_tp_cm.PGN_of_the_packeted_message
                = (data[7] << 16) | (data[6] << 8) | data[5];
...
/*
 * Send information to other ECU about how much sequence data packages this ECU is going to send to
 * other ECU PGN: 0x00EC00 (60416)
 */
