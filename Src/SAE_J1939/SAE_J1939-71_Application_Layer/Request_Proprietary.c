...
ENUM_J1939_STATUS_CODES SAE_J1939_Response_Request_Proprietary_A(J1939_t* j1939, uint8_t DA)
{
    ...
    if (length_of_each_field < 9) {
        /* If each field have the length 8 or less, then we can send Proprietary A as it was a
         * normal message */
        ...
        memcpy(j1939->this_ecu_tp_dt.data,
               j1939->this_proprietary.proprietary_A.data,
