                                                     ...
                                                     uint16_t seed)
{
    ...
    response_data[1] = ((number_of_allowed_bytes >> 3) & 0xE0) | (0b1 << 4) | (status << 1)
        | 0b1; /* bit 5 and 1 are reserved */
...
/*
 * Store the DM15 information about other ECU (This is actually the response after DM14 request
 * according to J1939 standard) PGN: 0x00D800 (55296)
 */
