 ...
 * PGN: 0x00EE00 (60928)
 */
ENUM_J1939_STATUS_CODES SAE_J1939_Send_Address_Not_Claimed(J1939_t* j1939)
{
...
/*
 * Store the address not claimed information about other ECU. In this case, SA will always be 0xFE =
 * 254 PGN: 0x00EE00 (60928)
 */
void SAE_J1939_Read_Address_Not_Claimed(J1939_t* j1939, uint8_t SA, uint8_t data[])
{
