                                                         ...
                                                         uint8_t vehicle_system_instance)
{
    ...
    j1939->this_ecu_tp_dt.data[7]
        = (arbitrary_address_capable << 7) | (industry_group << 4) | vehicle_system_instance;
...
/*
 * Read the commanded address from another ECU. Will always be called from Transport Protocol Data
 * Transfer due to 9 bytes of data PGN: 0x00FED8 (65240)
 */
void SAE_J1939_Read_Commanded_Address(J1939_t* j1939, uint8_t data[])
{
    ...
    j1939->information_this_ECU.this_name.identity_number
    ...
    Save_Struct((uint8_t*)&j1939->information_this_ECU,
                sizeof(Information_this_ECU),
