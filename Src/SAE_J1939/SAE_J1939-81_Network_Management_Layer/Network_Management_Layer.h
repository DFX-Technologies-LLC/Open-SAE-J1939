...
/* Commanded address */
ENUM_J1939_STATUS_CODES SAE_J1939_Send_Commanded_Address(J1939_t* j1939,
                                                         uint8_t DA,
                                                         uint8_t new_ECU_address,
...
void SAE_J1939_Read_Commanded_Address(J1939_t* j1939, uint8_t data[]);

/* Delete address */
ENUM_J1939_STATUS_CODES
SAE_J1939_Send_Address_Delete(J1939_t* j1939, uint8_t DA, uint8_t old_ECU_address);
void SAE_J1939_Read_Address_Delete(J1939_t* j1939, uint8_t data[]);
